...
class PrivacyPolicyDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(activity)
            ...
            .setNegativeButton(R.string.privacy_policy_title) { _, _ ->
                open(activity, privacyPolicyUrl)
            }
    ...
    companion object {
        ...
        fun showIfNeverPrompted(activity: Activity, appName: String, privacyPolicyUrl: String) {
            if (privacyPolicyPrompted(activity.applicationContext)) return

            show(activity, appName, privacyPolicyUrl)
        }

        fun show(activity: Activity, appName: String, privacyPolicyUrl: String) {
            try {
